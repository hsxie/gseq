...
if(irun==0)
    ...
    %%%%%%%%%%%%%%%coils%%%%%%%%%%%%%%%%%%%%%
    if icoil==1
        hl=[0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09,...
            0.09,0.09,0.09,0.09,0.09,0.09,0.09,0.09];
        rl=[0.45,0.45,0.45,0.45,0.45,0.54,0.63,0.63,0.63,0.63,0.63,0.63,0.63,0.63,0.63,0.63,...
            0.63,0.63,0.54,0.45,0.45,0.45,0.45,0.45];
        zl=[-3.312976756299235,-3.100861384204698,-2.855452177876161,-2.593263233283414,-2.326779738264207,...
            -2.046305749072202,-1.740728563057488, -1.424569958981702, -1.108145712611496, -0.796016016667750,...
            -0.479857412591963, -0.163433166221757, 0.163433166221757, 0.479857412591963, 0.796016016667750,...
            1.108145712611496, 1.424569958981702, 1.740728563057488, 2.046305749072202, 2.326779738264207,...
            2.593263233283414, 2.855452177876161, 3.100861384204698, 3.312976756299235];
        wl=[0.14,0.14,0.14,0.14,0.14,0.14,0.14, 0.14,0.14,0.14,0.14,0.14,0.14,0.14, 0.14,0.14,...
            0.14,0.14,0.14,0.14,0.14,0.14,0.14,0.14];
        Il=[2.966781507328271e3,2.966781507328271e3,2.076747055129789e3,2.076747055129789e3,2.076747055129789e3,...
            2.076747055129789e3,2.076747055129789e3,1.483390753664135e3,1.483390753664135e3,1.483390753664135e3,...
            1.483390753664135e3,1.483390753664135e3,1.483390753664135e3,1.483390753664135e3,1.483390753664135e3,...
            1.483390753664135e3,1.483390753664135e3,2.076747055129789e3,2.076747055129789e3,2.076747055129789e3,...
            2.076747055129789e3,2.076747055129789e3,2.966781507328271e3,2.966781507328271e3]*100;
    elseif icoil==2
...
%     jN0=floor(0.5*nZ)-floor(-1.26/dZ);
    jN0=floor(0.5*nZ)-floor(1.5/dZ);
%     for jz=floor(0.5*nZ) % 19-06-23 22:00 update
    for jz=jN0 % 20-12-20 22:00 update
        for jr=1:(jrb(jz)-1)
    ...
    if(mod(it-2,100)==0) % plot
        ...
        plot(rr,Jzeta(:,jN0)/max(abs(Jzeta(:,jN0))),'m','linewidth',3);box on;grid on;
        ...
        subplot(236);
        plot(rr,psi(:,jN0),'m','linewidth',3);box on;grid on;
...
%%
Rq=R;Zq=Z;psiq=psi;
filename='psiq_fixed_FIX';
save([filename,'.mat'],'Rq','Zq','psiq','Jzeta','P','jrb','zzb','rrb','psib','Z0','Be','Rs',...
    'nR','nZ','C');
save('psiq1_fixed_FIX.mat','Rq','Zq','psiq','Jzeta','P','jrb','Z0','zl','wl','rl','hl','C','E','jN0');
